...
export function SongActions({ track, liked, canRemove, onClose, onRemove, onLike, onShare, onReuse, onRadio }: {
  track: AudioTrack; liked: boolean; canRemove: boolean; onClose: () => void; onRemove: () => void; onLike: () => void;
  onShare: () => void; onReuse: (audio: boolean) => void; onRadio: () => void;
}) {
  ...
  const C = useSurfaceColors(); const A = styles(C);
