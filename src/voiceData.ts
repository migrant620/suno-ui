export type PublicVoice = { id: string; name: string; creatorId: string; trial: boolean; local?: boolean };

// Local examples contain no trained voice model or third-party voice recording.
