...
export function VoiceDetails({ voice, creator, account, songs, player, onClose, onUse, onCreator, onSongOptions, ownVoice }: {
  ownVoice?: OwnVoice;
  voice: PublicVoice; creator: ExampleCreator; account: ReturnType<typeof useLocalProfile>; songs: AudioTrack[];
  player: ReturnType<typeof useLibraryPlayback>; onClose: () => void; onUse: () => void; onCreator: () => void; onSongOptions: (song: AudioTrack) => void;
}) {
