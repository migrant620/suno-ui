...
export function HookPreview({ clip, active, onOpen, position }: { clip: ExampleHook; active: boolean; onOpen: () => void; position: React.MutableRefObject<Record<string, number>> }) {
